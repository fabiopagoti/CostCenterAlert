sap.ui.define([
		...
		"festo/co/costcenteralert/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all CostCenterGroups to be able to check for the total amount
						this.waitFor(this.createAWaitForAnEntitySet({
							entitySet: "CostCenterGroups",
